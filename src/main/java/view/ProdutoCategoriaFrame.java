...
public class ProdutoCategoriaFrame extends JFrame {
    ...
    private void alterar() {
        var objetoDaLinha = (Object) modelo.getValueAt(tabela.getSelectedRow(), tabela.getSelectedColumn());
        if (objetoDaLinha instanceof Integer) {
            var id = (Integer) objetoDaLinha;
            var nome = textoNome.getText();
            var descricao = textoDescricao.getText();
    ...
    private void deletar() {
        ...
        if (objetoDaLinha instanceof Integer) {
            ...
            this.modelo.removeRow(tabela.getSelectedRow());
    ...
    private void salvar() {
        if (!textoNome.getText().equals("") && !textoDescricao.getText().equals("")) {
            var produto = new Produto(textoNome.getText(), textoDescricao.getText());
